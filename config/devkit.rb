  ...
  MSYS = OpenStruct.new(
    ...
    :files => {
      :url_1 => [
        ...
        'ncurses-6.0.20160220-1-i686.pkg.tar.xz',
        ...
        'libexpat-2.1.1-1-i686.pkg.tar.xz',
        'libtool-2.4.6-2-i686.pkg.tar.xz',
        'bsdtar-3.2.0-1-i686.pkg.tar.xz',
        'bsdcpio-3.2.0-1-i686.pkg.tar.xz',
        'libarchive-3.2.0-1-i686.pkg.tar.xz',
        'libbz2-1.0.6-2-i686.pkg.tar.xz',
        'liblzma-5.2.2-1-i686.pkg.tar.xz',
        'liblzo2-2.09-1-i686.pkg.tar.xz',
        'libnettle-3.2-1-i686.pkg.tar.xz',
